  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dashboards-dashboard-module"], {
    ...
    function srcAppDashboardsDashboardComponentsInfoCardInfoCardComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var InfocardComponent = /*#__PURE__*/function () {
        function InfocardComponent(Srvc, router) {
        ...
        _createClass(InfocardComponent, [{
          ...
          value: function getDashboard() {
            ...
            this.Srvc.getDashboardData().subscribe(function (res) {
              ...
              _this.totalword = res.data.totalConvertedWords;
            });
          }
        }, {
          key: "gotousers",
      ...
      InfocardComponent.ɵfac = function InfocardComponent_Factory(t) {
        return new (t || InfocardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_convservice_service__WEBPACK_IMPORTED_MODULE_3__["ConvserviceService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]));
      };
      ...
      InfocardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 49,
        vars: 4,
        consts: [[1, "row"], [1, "col-md-3"], [1, "card"], [1, "card-body", "card-box", "p-2"], [1, "d-flex", "align-items-center", 3, "click"], [1, "m-r-10"], [1, "btn", "btn-circle", "btn-xl", "bg-danger"], [1, "sl-icon-people", "text-white"], [1, "ml-auto"], [1, "m-b-0", "font-light"], [1, "d-flex", "align-items-center"], [1, "btn", "btn-circle", "btn-xl", "btn-info"], [1, "fa", "fa-shopping-cart", "text-white"], [1, "sl-icon-social-soundcloud", "text-white", 2, "font-size", "40px"], [2, "width", "220px"], [1, "card-body", "card-box", "p-2", 3, "click"], [1, "sl-icon-user", "text-white"]],
        template: function InfocardComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function InfocardComponent_Template_div_click_4_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function InfocardComponent_Template_div_click_39_listener() {
              return ctx.gotousers();
            });
    ...
    function srcAppDashboardsDashboardComponentsSalesSalesComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_convservice_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! src/app/convservice.service */
      "./src/app/convservice.service.ts");
      /* harmony import */
      ...
      var SalesComponent = /*#__PURE__*/function () {
        function SalesComponent(Srvc) {
          ...
          this.barChartData = [{
            data: this.valuearraypre,
            label: 'Freemium'
          }, {
            data: this.valuearraysec,
            label: 'premium'
          }];
          this.barChartColors = [{
        ...
        _createClass(SalesComponent, [{
          ...
          value: function getPremier() {
            ...
            this.Srvc.getPackagelist(datapre).subscribe(function (res) {
              ...
              setTimeout(function () {
                _this3.barChartData = [{
                  data: _this3.valuearraypre,
                  label: 'Freemium'
                }, {
                  data: _this3.valuearraysec,
                  label: 'premium'
                }];
                _this3.barChartLabels = _this3.keyarraypre;
              }, 1000);
            });
          }
        }, {
          key: "onChangepre",
          value: function onChangepre(events) {
            var _this4 = this;
            ...
            this.Srvc.getPackagelist(datapre).subscribe(function (res) {
              ...
              setTimeout(function () {
                _this4.barChartData = [{
                  data: _this4.valuearraypre,
                  label: 'Freemium'
                }, {
                  data: _this4.valuearraysec,
                  label: 'premium'
                }];
                _this4.barChartLabels = _this4.keyarraypre;
              }, 1000);
            });
          }
        }, {
          ...
          key: "onChange",
          value: function onChange(events) {
            var _this5 = this;
            ...
            this.Srvc.getUserslist(data).subscribe(function (res) {
              ...
              setTimeout(function () {
                _this5.barChart2Data = [{
                  data: _this5.valuearray,
                  label: 'Sales'
                }];
                _this5.barChartLabels1 = _this5.keyarray;
              }, 1000);
            });
          }
        }]);
      ...
      SalesComponent.ɵfac = function SalesComponent_Factory(t) {
        return new (t || SalesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_convservice_service__WEBPACK_IMPORTED_MODULE_2__["ConvserviceService"]));
      };
      ...
      SalesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 38,
        vars: 12,
        consts: [[1, "row"], [1, "col-12"], [1, "col-md-6"], [1, "card"], [1, "card-body"], [1, "d-flex", "align-items-center"], [1, "btn-circle", "btn-lg", "btn", "btn-outline-secondary"], [1, "sl-icon-people"], [1, "m-l-10"], [1, "card-title"], [1, "ml-auto"], [1, "custom-select", "b-0", 3, "change"], ["selected", "", "value", "weekly"], ["value", "monthly"], ["baseChart", "", 3, "datasets", "labels", "options", "legend", "chartType", "colors"], [1, "col-lg-6"], ["selected", "", "value", "0"], ["value", "1"]],
        template: function SalesComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function SalesComponent_Template_select_change_15_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function SalesComponent_Template_select_change_32_listener($event) {
              return ctx.onChangepre($event.target.value);
            });
        ...
        directives: [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["NgSelectOption"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ɵangular_packages_forms_forms_x"], ng2_charts__WEBPACK_IMPORTED_MODULE_4__["BaseChartDirective"]],
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SalesComponent, [{
          ...
          return [{
            type: src_app_convservice_service__WEBPACK_IMPORTED_MODULE_2__["ConvserviceService"]
          }];
        }, null);
      })();
      /***/
    ...
    function srcAppDashboardsDashboard1Dashboard1ComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _dashboard_components_cheflist_cheflist_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../dashboard-components/cheflist/cheflist.component */
      "./src/app/dashboards/dashboard-components/cheflist/cheflist.component.ts");
